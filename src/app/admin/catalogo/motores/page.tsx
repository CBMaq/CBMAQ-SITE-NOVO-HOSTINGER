...
export default async function MotoresCatalogoPage() {
  const products = await getCatalogProducts("engine");
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-serif font-bold">Motores</h1>
            <p className="text-muted-foreground">Gerencie o catálogo de motores da CBMaq.</p>
          </div>
        </div>
        ...
        <Button asChild className="h-11 rounded-xl px-6 gap-2 shadow-lg hover:shadow-primary/20 transition-all bg-primary text-white font-bold">
          <Link href="/admin/catalogo/motores/novo">
