...
export const getTelemetriaEmailHtml = (data: TelemetriaEmailData) => {
  const {
    fullName,
    email,
    phone,
  ...
  return `
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Nova solicitação - Telemetria</h1>
            <p>Novo pedido de informações sobre telemetria e rastreamento recebido via site</p>
          </div>
          <div class="content">
            <p style="font-size: 16px; margin-bottom: 25px;">
              Olá, equipe <strong>CBMaq</strong>,<br />
              Um novo contato foi recebido na página de Telemetria:
            </p>
            <table class="lead-table">
              ...
              <tr><td class="label">Tipo de Equipamento</td><td class="value">${equipmentType}</td></tr>
              <tr><td class="label">Marca</td><td class="value">${brand}</td></tr>
              <tr><td class="label">Ano de Fabricação</td><td class="value">${manufactureYear}</td></tr>
              <tr><td class="label">Série da Máquina</td><td class="value">${serialNumber}</td></tr>
              <tr><td class="label">Valor Aprox. do Equipamento</td><td class="value">${approximateValue}</td></tr>
            </table>
