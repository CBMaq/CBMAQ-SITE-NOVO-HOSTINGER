...
export const getRevendedorEmailHtml = (data: RevendedorEmailData) => {
  const {
    fullName,
    email,
    phone,
  ...
  return `
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Novo Cadastro de Revendedor</h1>
            <p>Recebido via formulário do site CBMaq</p>
          </div>
          <div class="content">
            <p style="font-size: 16px; margin-bottom: 25px;">
              Olá, equipe <strong>CBMaq</strong>,<br />
              Você recebeu uma nova solicitação para revendedor:
            </p>
