...
export function TrabalheConoscoHero() {
  const scrollToForm = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    const formSection = document.getElementById("curriculum-form");
    if (formSection) {
  ...
  return (
    <section className="relative w-full h-[600px] md:h-[700px] lg:h-[780px] flex items-center overflow-hidden">
      {/* Background Image */}
      <Image
        src="https://mfwdxbpejpkyvawaypnj.supabase.co/storage/v1/object/public/service_images/trabalhe-conosco-topo-copy.webp"
        alt="Trabalhe Conosco CBMaq"
        fill
      ...
      <div className="section-container relative z-20 w-full h-full flex flex-col justify-center items-start">
        ...
        >
          ...
          <p className="text-[1.125rem] md:text-[1.25rem] font-light text-white/90 leading-relaxed max-w-[480px] mb-12 mx-0">
            Faça parte de uma equipe que valoriza pessoas, crescimento e compromisso com excelência.
          </p>

          <a
            href="#curriculum-form"
