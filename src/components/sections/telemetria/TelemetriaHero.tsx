...
export function TelemetriaHero() {
  const baseUrl = "https://mfwdxbpejpkyvawaypnj.supabase.co/storage/v1/object/public/service_images/topo-telemetria-cbmaq-copy.webp";
  ...
  return (
    <section className="relative w-full h-[600px] md:h-[700px] lg:h-[780px] flex items-center overflow-hidden">
      ...
      <Image
        src={`${baseUrl}`}
        alt="Telemetria e Rastreamento CBMaq"
        fill
      ...
      <div className="section-container relative z-20 w-full h-full flex flex-col justify-center">
        <motion.div
           ...
           className="max-w-[840px] mt-16 md:mt-0 px-4 md:px-8"
        >
          ...
          <p className="text-[1.125rem] md:text-[1.25rem] font-light text-white/90 leading-relaxed max-w-[600px] mb-12">
            Monitore o desempenho de suas máquinas em tempo real e tome decisões baseadas em dados precisos.
          </p>
